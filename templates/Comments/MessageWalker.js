                                          ...
                                          <tbody>
                                            <tr>
                                              ...
                                              >
                                                <p>
                                                  Hola ${walkerName},
                                                  recientemente hemos recibido un
                                                  reporte del paseo que realizaste
                                                  el dia ${dateDay
                                                    .split("-")
                                                    .reverse()
                                                    .join("-")} a las
                                                  ${dateHour} hrs. El cliente
                                                  informó el siguiente
                                                  inconveniente.
                                                </p>
